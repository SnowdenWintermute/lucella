...
def parse_args():
    ...
    parser.add_argument("--env-id", type=str, default="multiwalker_v9")
...
if __name__ == "__main__":
    ...
    # env setup
    env = importlib.import_module(f"pettingzoo.sisl.{args.env_id}").parallel_env()
    ...
    print("SINGLE OBS: ", envs.single_observation_space)
