...
import { createUser, findUser, signTokenAndCreateSession } from "../services/user.service";
import AppError from "../classes/AppError";

// Exclude this fields from the response
export const excludedFields = ["password"];

const accessTokenExpiresIn: number = parseInt(process.env.ACCESS_TOKEN_EXPIRES_IN || "1");
