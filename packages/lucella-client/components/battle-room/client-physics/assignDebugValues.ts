...
export default function (
  ...
  const ticksSinceLastClientTickConfirmedByServer =
    game.currentTick - lastProcessedClientTick;
  ...
  game.debug.clientPrediction.ticksSinceLastClientTickConfirmedByServer =
    ticksSinceLastClientTickConfirmedByServer;
  game.debug.clientPrediction.clientServerTickDifference =
    game.currentTick - lastUpdateFromServerCopy.tick;
  game.debug.clientPrediction.lastProcessedClientInputNumber =
