...
import styles from "./score-screen-modal.module.scss";
...
export default function ScoreScreenModal() {
  ...
  return (
    <Modal title={`Game ${gameRoom.gameName} result`} setParentDisplay={setParentDisplay} extraStyles={styles["score-screen-modal"]} noPadding>
      <div className={styles["score-screen-modal__contents"]} data-cy="score-screen-modal">
        <div className={styles["score-screen-modal__left"]}>
          <div className={styles["score-screen-modal__player-name-and-score"]}>
        ...
        <div className={styles["score-screen-modal__right"]}>
          <div className={styles["score-screen-modal__game-result"]}>
            {wasVictory ? "Victory" : "Defeat"}
            {!Number.isNaN(eloDiff) && (
              <span className={styles["score-screen-modal__elo-diff"]}>
                {eloDiffSign}
                {eloDiff}
              </span>
            )}
          </div>
          <div className={styles["score-screen-modal__elo-and-rank-changes"]}>
            {!wasRanked && <div className={styles["score-screen-modal__elo-and-rank-changes-block"]}>No changes to ladder rating</div>}
            {wasRanked && (
              <>
                <div className={styles["score-screen-modal__elo-and-rank-changes-block"]}>
