...
function PatchNotes({ setViewingPatchNotes, versionNumber }: { setViewingPatchNotes: (value: boolean) => void; versionNumber: string }) {
  return (
    <div className="patch-notes">
      ...
      <span className="patch-notes__version-name">{versionNumber} "game speed"</span>
      <ul>
        <li>Changed the default game settings to a slower speed and larger orbs</li>
      </ul>
      <span className="patch-notes__version-name">alpha 0.6.0 "physics options"</span>
      <ul>
