...
import { GET_LADDER_PAGE, CHANGE_LADDER_PAGE_VIEWING, GET_BATTLE_ROOM_USER_RECORD } from "./types";
...
export const getBattleRoomUserRecord = (username) => async (dispatch) => {
  try {
    ...
    dispatch(setAlert("User not found. Please note that names are case sensitive", "danger"));
  }
};
