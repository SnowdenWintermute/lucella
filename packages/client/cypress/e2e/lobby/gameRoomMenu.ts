...
export default function gameRoomMenu() {
  ...
  it("provides the functionality of the game room menu", () => {
    ...
    cy.findByLabelText(ARIA_LABELS.GAME_ROOM.PLAYER_READY_STATUS(PlayerRole.HOST)).should("contain.text", APP_TEXT.GAME_ROOM.PLAYER_READY_STATUS.NOT_READY);
    cy.clickButton(BUTTON_NAMES.GAME_ROOM.READY);
    cy.findByLabelText(ARIA_LABELS.GAME_ROOM.PLAYER_READY_STATUS(PlayerRole.HOST)).should("contain.text", APP_TEXT.GAME_ROOM.PLAYER_READY_STATUS.READY);
    cy.clickButton(BUTTON_NAMES.GAME_ROOM.READY);
    cy.findByLabelText(ARIA_LABELS.GAME_ROOM.PLAYER_READY_STATUS(PlayerRole.HOST)).should("contain.text", APP_TEXT.GAME_ROOM.PLAYER_READY_STATUS.NOT_READY);
