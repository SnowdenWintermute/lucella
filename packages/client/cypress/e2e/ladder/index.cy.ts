...
describe("ladder", () => {
  ...
  it(
    `finds own rank and opponent rank via page and search, then plays a game and sees updated results in
    ...
    () => {
      ...
      cy.visitPageAndVerifyHeading(`${Cypress.env("BASE_URL")}${FrontendRoutes.LADDER}`, "ladder");
